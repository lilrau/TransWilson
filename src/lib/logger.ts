...
export class Logger {
  ...
  static async info(service: string, message: string, metadata?: Record<string, string | number | boolean>) {
    'use server'
  ...
  static async warn(service: string, message: string, metadata?: Record<string, string | number | boolean>) {
    'use server'
  ...
  static async error(service: string, message: string, metadata?: Record<string, string | number | boolean>) {
    'use server'
