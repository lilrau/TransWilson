  ...
  return (
    <div className="flex-1 p-4 md:p-6">
      <div className="grid gap-4 md:gap-6 lg:grid-cols-2 xl:grid-cols-3">
        {/* Cards de resumo */}
        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6 dark:text-white">
          <h2 className="text-lg font-medium mb-2">Fretes Ativos</h2>
          <p className="text-3xl font-bold">12</p>
          <p className="text-sm text-slate-500 dark:text-zinc-400 mt-2">4 a caminho, 8 em carregamento</p>
        </div>

        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6 dark:text-white">
          <h2 className="text-lg font-medium mb-2">Motoristas Disponíveis</h2>
          <p className="text-3xl font-bold">8</p>
          <p className="text-sm text-slate-500 dark:text-zinc-400 mt-2">De um total de 15 motoristas</p>
        </div>

        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6 dark:text-white">
          <h2 className="text-lg font-medium mb-2">Faturamento Mensal</h2>
          <p className="text-3xl font-bold">R$ 87.500</p>
          <p className="text-sm text-slate-500 dark:text-zinc-400 mt-2">+12% em relação ao mês anterior</p>
        </div>
      </div>

      <div className="mt-6 bg-white dark:bg-zinc-900 rounded-lg shadow p-6 dark:text-white">
